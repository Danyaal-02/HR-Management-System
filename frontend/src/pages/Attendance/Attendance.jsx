...
function Attendance() {
      ...
      <div className="attendance-stats" id="attendance-stats-cards">
        <div className="attendance-stat-card attendance-stat-card--present">
          ...
          <div className="attendance-stat-card__content">
            <span className="attendance-stat-card__number">
          ...
          <tbody>
            {employeeMonthLogs.length > 0 ? (
              employeeMonthLogs.map((log, idx) => {
                const { total, extra } = calculateWorkHours(
                  log.checkIn,
                  log.checkOut
                )
                return (
                  <tr key={idx}>
                    ...
                    <td>
                      <span
                        className={`attendance-extra ${extra !== '00:00' ? 'attendance-extra--has' : ''}`}
                      >
                        {extra}
                      </span>
                    </td>
  ...
  const renderAdminView = () => (
    <div className="attendance-admin" id="attendance-admin-view">
      ...
      <div className="attendance-table-container">
        <table
          className="attendance-table attendance-table--admin"
                      ...
                      <div className="attendance-employee-cell">
                        {log.employee?.profilePicture ? (
                          <img
                            ...
                            className="attendance-avatar-img"
                          />
                        ) : (
                        ...
                        <div className="attendance-employee-info">
                          <span className="attendance-employee-name">
                            {log.employee?.name || 'Unknown'}
                          </span>
                          <span className="attendance-employee-dept">
          ...
          <div className="attendance-admin-employee-section">
            ...
            <div className="attendance-table-container">
              <table
                ...
                id="admin-monthly-summary-table"
              >
                <thead>
                  <tr>
                    <th>Employee</th>
                  ...
                  {employees.map((emp) => {
                    ...
                    return (
                      <tr key={emp.id}>
                        ...
                        <td>
                          <span className="attendance-payable-badge">
                            {stats.payableDays}
                          </span>
                        </td>
                      </tr>
