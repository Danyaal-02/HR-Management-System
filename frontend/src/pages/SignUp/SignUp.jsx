              ...
              <div className="auth-form__logo-mobile">
                <svg width="36" height="36" viewBox="0 0 48 48" fill="none">
                  <rect
                    ...
                    height="48"
                    rx="12"
                    fill="url(#logo-gradient-su-mobile)"
                  />
                  <path
                    d="M14 16h8v4h-8v-4zm0 8h20v4H14v-4zm0 8h16v4H14v-4zm12-16h8v4h-8v-4z"
                    fill="white"
            ...
            <div className="auth-form__fields">
              ...
              <div className="auth-field">
                ...
                <div className="signup-company-row">
                  <div
                    className={`auth-field__input-wrapper ${errors.companyName ? 'auth-field__input-wrapper--error' : ''}`}
                  >
                    <svg
                ...
                {errors.logo && (
                  <span className="auth-field__error">{errors.logo}</span>
                )}
              </div>
              ...
              <div className="auth-field">
                ...
                <div
                  className={`auth-field__input-wrapper ${errors.name ? 'auth-field__input-wrapper--error' : ''}`}
                >
                  <svg
                    className="auth-field__icon"
                    width="18"
              ...
              <div className="auth-field">
                ...
                <div
                  className={`auth-field__input-wrapper ${errors.email ? 'auth-field__input-wrapper--error' : ''}`}
                >
                  <svg
                    className="auth-field__icon"
                    width="18"
              ...
              <div className="auth-field">
                ...
                <div
                  className={`auth-field__input-wrapper ${errors.phone ? 'auth-field__input-wrapper--error' : ''}`}
                >
                  <svg
                    className="auth-field__icon"
                    width="18"
