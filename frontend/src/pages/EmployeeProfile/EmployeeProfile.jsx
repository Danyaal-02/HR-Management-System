        ...
        <section className="profile-header-card profile-header-card--viewonly" id="employee-profile-header">
          <div className="profile-header-card__avatar-section">
            <div className="profile-header-card__avatar-container profile-header-card__avatar-container--viewonly">
              {employee.profilePicture ? (
                <img src={employee.profilePicture} alt={employee.name} className="profile-header-card__avatar" />
              ) : (
            ...
            <div className="profile-header-card__basic-info">
              ...
              <p className="profile-header-card__role">{employee.role} Officer</p>
              <span className="profile-header-card__id">Emp ID: {employee.id}</span>
            </div>
          </div>
          ...
          <div className="profile-header-card__details">
            <div className="profile-detail-item">
              ...
              <span className="profile-detail-item__value">{employee.company || 'Odoo India'}</span>
            </div>
            <div className="profile-detail-item">
            ...
            <div className="profile-detail-item">
              ...
              <span className="profile-detail-item__value">{employee.manager}</span>
            </div>
            <div className="profile-detail-item">
            ...
            <div className="profile-detail-item">
              ...
              <span className="profile-detail-item__value">{employee.mobile || 'Not set'}</span>
            </div>
            <div className="profile-detail-item">
              <span className="profile-detail-item__label">Location</span>
              <span className="profile-detail-item__value">{employee.location}</span>
            </div>
          </div>
        </section>
