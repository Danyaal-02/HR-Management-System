        ...
        <div className="auth-form-wrapper">
          <form className="auth-form" onSubmit={handleSubmit} id="signin-form">
            <div className="auth-form__header">
              ...
              <p className="auth-form__description">Welcome back! Please enter your credentials.</p>
            </div>
            ...
            <div className="auth-form__fields">
              <div className="auth-field">
                ...
                <div className={`auth-field__input-wrapper ${errors.loginId ? 'auth-field__input-wrapper--error' : ''}`}>
                ...
                {errors.loginId && <span className="auth-field__error">{errors.loginId}</span>}
              </div>
            ...
            <p className="auth-form__footer">
              ...
              <Link to="/sign-up" className="auth-form__link" id="signin-goto-signup">
                Sign Up
              </Link>
            </p>
          </form>
